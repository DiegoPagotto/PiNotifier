...
public class MessageUtils {
    ...
    public static String setDiscordViaChat = prefix + "§aDigite no chat o seu §rdiscord §ano formato: §rNome#0000";
    ...
    public static String definedDiscord = prefix + "§aSeu discord foi definido para §r{discord}§a.";
    ...
    public static String wrongPhoneFormat = prefix + "§cO telefone informado não é válido.";
}
